...
本项目是一次 Vibe Coding 实践：由开发者提出需求，AI 编程助手（CodeBuddy）负责全部代码实现、界面调整与问题修复。
...
| 耗时 | 约 2 天 |
| Token 消耗 | 约 1 亿 |
| 使用模型 | GPT-Sol、Terra、Hy3、DeepSeek V4 |
| 技术栈 | uni-app + Vue 3（小程序端） / Spring Boot + MyBatis-Plus + PostgreSQL（后端） |

麻雀虽小，但包含了完整的微信登录、房间体系、给分记账、流水统计与消息展示等能力。
